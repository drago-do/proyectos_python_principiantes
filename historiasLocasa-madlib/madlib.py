...
madlib = f"Hola, yo soy {sujeto1}. Hoy estoy aprendiendo a programar con {sujeto2}, el es muy {adjetivo1}. Mañana tendre que {verbo1} la casa, mi perro intenta {verbo2} su cola, y mi gato esta comiendo algo muy {adjetivo2}"
